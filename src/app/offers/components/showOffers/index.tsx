...
export function ShowOffers() {
  ...
  const handleAddItemCart = (item: string) => {
    toast.info(`${item} unregistered... cart under construction`);
  };
  ...
  return (
    <div className="w-full flex flex-col gap-2 justify-center items-center">
      <main className="w-full flex justify-center items-center flex-col gap-4">
        ...
        <div className="w-full md:max-w-[80%] flex items-center justify-center bg-primary rounded-full p-2 relative">
          <Input
            type="text"
          ...
          <Button
            ...
            className="absolute group right-2 rounded-r-full bg-secondary text-primary hover:bg-secondary"
          >
            <Search
              size={0}
            ...
            >
              <CardContent className="relative group flex flex-col w-[150px] h-[210px] sm:w-[220px] sm:h-[340px] md:w-[240px] md:h-[360px] aspect-square items-center justify-center rounded-xl text-secondary p-0 ">
                <div className="flex justify-center items-center w-full  h-full rounded-xl">
                  <Button
                    className="absolute z-10 top-0 left-[-8px] bg-transparent hover:bg-primary/0 duration-300 w-auto h-auto flex justify-center items-center drop-shadow"
                    onClick={() => handleAddItemCart(item.type)}
                  >
                    <ShoppingCart className="text-primary bg-secondary p-1 rounded-xl w-[40px] h-auto cursor-pointer hover:scale-110 duration-300" />
                  </Button>
